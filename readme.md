...
- **persist_date** - дата
- **type** - тип репутации
- **author_id** - идентификационный номер автора
- **sender_id** - идентификационный номер отправителя
- **question_id** - идентификационный номер вопроса
- **answer_id** - идентификационный номер ответа
```
...
- **reputations_for_merit** - минимальное количество очков репутации для получения знака
