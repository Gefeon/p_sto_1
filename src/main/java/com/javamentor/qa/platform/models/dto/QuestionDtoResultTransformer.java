...
//        LocalDateTime persistDate = (LocalDateTime) tupleMap.get(QuestionDto.PERSIST_DATE_ALIAS);
//        LocalDateTime lastUpdateDate = (LocalDateTime) tupleMap.get(QuestionDto.LAST_UPDATE_DATE_ALIAS);
...
//                questionId,
//                id -> new QuestionDto(questionId, title, authorId, authorName, authorImage, description, persistDate,lastUpdateDate, viewCount,countAnswer,countValuable)
//        );
